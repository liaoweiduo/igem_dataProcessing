...
clear all;
rawpath = {...
    '/Volumes/Seagate Expansion Drive/IGEM/20161011microfluidics/G/0/',...
    '/Volumes/Seagate Expansion Drive/IGEM/20161011microfluidics/G/200/'...
    '/Volumes/Seagate Expansion Drive/IGEM/20161011microfluidics/G/0/'...
    '/Volumes/Seagate Expansion Drive/IGEM/20161011microfluidics/G/200/'...
    '/Volumes/Seagate Expansion Drive/IGEM/20161011microfluidics/G/0/',...
    '/Volumes/Seagate Expansion Drive/IGEM/20161011microfluidics/G/200/'...
...
np=2;  %num of points in one picture
interval=0.4;
Title = '20161011,RGECO,microfluidics';
Legend= {...
    'RGECO   background fast',...
    'RGECO   200ul/min fast'...
    'RGECO   background mid',...
    'RGECO   200ul/min mid'...
    'RGECO   background slow',...
    'RGECO   200ul/min slow'...
    };
...
for i=1:nf
    ...
    for i1=1:nt
        ...
        imagesc(rawImg);colorbar; caxis([0,500]);
