...
rawpath = {...
    ...
    '/Volumes/Seagate Expansion Drive/IGEM/20161012osmotic/GECO+PIEZO/90/'...
    '/Volumes/Seagate Expansion Drive/IGEM/20161012osmotic/GECO+PIEZO/80/'...
    '/Volumes/Seagate Expansion Drive/IGEM/20161012osmotic/GECO+PIEZO/70/'...
    '/Volumes/Seagate Expansion Drive/IGEM/20161012osmotic/GECO+PIEZO/60/'...
...
interval=0.4;
Title = '20161012,R-GECO+Piezo1,osmotic,original ¦Ð(in):300 mOsm/kg.H2O';
Legend= {...
    'R-GECO+Piezo1   ¦Ð(out):300 mOsm/kg.H2O',...
    'R-GECO+Piezo1   ¦Ð(out):270 mOsm/kg.H2O'...
    'R-GECO+Piezo1   ¦Ð(out):240 mOsm/kg.H2O'...
    'R-GECO+Piezo1   ¦Ð(out):210 mOsm/kg.H2O'...
    'R-GECO+Piezo1   ¦Ð(out):180 mOsm/kg.H2O'...
