...
rawpath = {...
    ...
    '/Volumes/Seagate Expansion Drive/IGEM/20160907osmotic/GECO/1_2/',...
    '/Volumes/Seagate Expansion Drive/IGEM/20160907osmotic/GECO/1_10/',...
    '/Volumes/Seagate Expansion Drive/IGEM/20160907osmotic/GECO/1_20/',...
    '/Volumes/Seagate Expansion Drive/IGEM/20160907osmotic/GECO/1-200/'...
    };
rawpath_p={...
...
Legend= {...
    'GECO ¦Ð(out):300 mOsm/kg.H2O',...
    'GECO ¦Ð(out):150 mOsm/kg.H2O',...
    'GECO ¦Ð(out):270 mOsm/kg.H2O',...
    'GECO ¦Ð(out):285 mOsm/kg.H2O',...
    'GECO ¦Ð(out):298.5 mOsm/kg.H2O'...
    };
